        ...
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <div class="collapse" id="collapseVideo" aria-labelledby="headingOne"
                    data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="">Embed link from youtube</a>
                        <a class="nav-link" href="uploadVideo.html">Upload Manually</a>
                        <a class="nav-link" href="manageVideo.html">Manage Videos</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseConsult" aria-labelledby="headingOne"
                    data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="#">New Consultations</a>
                        <a class="nav-link" href="#">Manage Consultations</a>
                ...
                <div class="collapse" id="collapseNews" aria-labelledby="headingOne"
                    data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="subscriberTable.html">Subscribed Clients</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseAdmin" aria-labelledby="headingOne"
                    data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="addAdmin.html">Add Admin</a>
                        <a class="nav-link" href="manageAdmin.html">Manage Admin</a>
                    </nav>
                </div>
